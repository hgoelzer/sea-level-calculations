...
sle_step_a2020 = sum(sle_a2020);
sle_step_g2020 = sum(sle_g2020);

% leap through problem from t0 to tend
sle_leap_a2020 = a2020_func(BED(1,[1,end]),BASE(1,[1,end]),SURFACE(1,[1,end]),params);
...
a2020_step_leap = [sle_step_a2020, sle_leap_a2020]
% compare a - g
g2020_step_leap = [sle_step_g2020, sle_leap_g2020]
